export var maps = [
  ...
  },
  {
    ...
    "neighbor_cities":[
      ...
      {"is_active" : true,"city_name" : "Pandaan","distance":26.1}
    ]
  },
  {
    "city_name" : "Pandaan",
    "neighbor_cities":[
      {"is_active" : true,"city_name" : "Lawang","distance":27.7},
      {"is_active" : true,"city_name" : "Sidoarjo","distance":26.5},
      {"is_active" : true,"city_name" : "Bangil","distance":10.7},
      {"is_active" : true,"city_name" : "Mojokerto","distance":44.5}
    ]
  },
  {
    "city_name" : "Bangil",
    "neighbor_cities":[
      {"is_active" : true,"city_name" : "Pandaan","distance":11.3},
  ...
  },
  {
    ...
    "neighbor_cities":[
      ...
      {"is_active" : true,"city_name" : "Pandaan","distance":19.9},
  ...
  },
  {
    ...
    "neighbor_cities":[
      ...
      {"is_active" : true,"city_name" : "Pandaan","distance":46.8},
  ...
  },
  {
    "city_name" : "Pacitan",
    "neighbor_cities":[
      {"is_active" : true,"city_name" : "Ponorogo","distance":69.4},
  ...
  },
  {
    ...
    "neighbor_cities":[
      {"is_active" : true,"city_name" : "Ponorogo","distance":100},
      {"is_active" : true,"city_name" : "Tulungagung","distance":36},
      {"is_active" : true,"city_name" : "Prigi","distance":44}
    ]
  },
  {
    "city_name" : "Prigi",
    "neighbor_cities":[
      {"is_active" : true,"city_name" : "Trenggalek","distance":38.6},
